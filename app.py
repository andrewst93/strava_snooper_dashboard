...
contact_button = dbc.Button(
    f"CONTACT ME", id=f"popover-bottom-target", className="mx-2", size="lg"
)
...
header = dbc.Navbar(
    [
        ...
        dbc.Collapse(
            dbc.Nav(
                [ty_website_link, contact_button, contact_popover],
                className="ml-auto",
...
# All page call backs for plot configuration, sliders etc.
